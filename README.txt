...
During development when data migration has NOT been initiated by a new version of the database schema the old database will have to be removed at

    ~/Library/Application\ Support/com.plumstep.JenkinsNotifier

This file only needs to be deleted if you have made changes to the schema JenkinsNotifier.xcdatamodeld.



KEY LOOP NAVIGATION http://lists.apple.com/archives/cocoa-dev/2007/Jan/msg01328.html

Guidelines for the key view loop

Subject: Guidelines for the key view loop
From: Justin Bur <email@hidden>
Date: Wed, 31 Jan 2007 11:02:06 -0500
